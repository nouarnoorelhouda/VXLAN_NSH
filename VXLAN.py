...
do = "send"
type = "vxlan_gpe_nsh"
inner_source_mac = "fa:16:3e:90:ea:51"
outer_source_mac = "fa:16:3e:90:ea:51"
inner_source_ip = "20.0.0.213"
outer_source_ip = "20.0.0.213"
inner_destination_mac = "fa:16:3e:aa:94:e7"
outer_destination_mac = "fa:16:3e:aa:94:e7"
inner_destination_ip = "20.0.0.225"
outer_destination_ip = "20.0.0.225"
outer_source_udp_port = 25
inner_destination_udp_port = 25
inner_source_udp_port = 25
number = 1
verbose = "on"
swap_ip = "True"
...
def build_udp_packet(src_ip, dest_ip, src_port, dest_port, data, swap_ip):
    ...
    #data = "sample message from one car to another"
    print ("DATA :", data)
...
def main():
    ...
    start_build_time = time.clock()
    print("start building a packet", start_build_time)
    if (do == "send"):
        ...
        macaddr = inner_source_mac.split(":")
        ...
        innerippack = build_udp_packet(inner_source_ip, inner_destination_ip, inner_source_udp_port, inner_destination_udp_port, "Sample message from car to another".encode('utf-8'), False)
    ...
    end_build_time = time.clock()
    #millis = int(round(end_time * 1000))
    print("end building a packet: ", end_build_time)

    """ Decode ethernet header """

    #print("arriving at decode")
    start_dec_time = time.clock()
    print("start decoding a packet", start_dec_time)
    decode_eth(ethpkt, myethheader)

    if (type == "eth_nsh"):
        print("i enter to decode eth_nsh")
        offset = eth_length
    ...
    """ Decode UDP header """
    #print("i enter to Decode UDP header")
    decode_udp(ethpkt, myudpheader)

    offset = eth_length + ip_length + udp_length + vxlan_length
    decode_nsh_baseheader(ethpkt, offset, mynshbaseheader)
    decode_nsh_contextheader(ethpkt, offset + nshbase_length, mynshcontextheader)
    end_dec_time = time.clock()
    #millis_dec = int(round(end_dec_time * 1000))
    print("end decoding a packet: ", end_dec_time)
